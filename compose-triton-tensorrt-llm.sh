...
export IMAGE="nvcr.io/nvidia/tritonserver:24.05-trtllm-python-py3"
export COMMAND="/scripts/triton-tensorrt-llm.sh meta-llama/Meta-Llama-3-8B-Instruct"
...
cp triton-tensorrt-llm.sh $HOME/scripts/triton/
